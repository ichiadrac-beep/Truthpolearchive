...
function AncientPage() {
  ...
  return (
    <FileDesk
      ...
      intro="Sites, tablets, and contact claims from the deep past — megaliths, Anunnaki, Watchers, flood teachers, and the pre-biblical sky files. Archaeology first; the folklore is on the card."
      tag="ANCIENT FILE"
      files={ANCIENT_FILES}
      deskPath="/ancient"
      seedId={file}
