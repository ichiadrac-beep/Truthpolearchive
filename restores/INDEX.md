...
| 3 | **restore file(3)** | [`restore-file-3.zip`](./restore-file-3.zip) · [`RESTORE-FILE-3.md`](./RESTORE-FILE-3.md) — signal bar, zoom bounce, sky hum, scratch redaction |
| 4 | restore file(4) | *(not created yet)* → `restore-file-4.zip` |
...
- restore file(3): https://github.com/ichiadrac-beep/Truthpolearchive/raw/main/restores/restore-file-3.zip
